        ...
        <div class="row pt-3">
          ...
          <div class="col-md-3 ">
            <div class="card bg-danger widget-flat">
                <div class="card-body">
                    ...
                    <h5 class="text-white font-weight-normal mt-0" title="Number of Customers">New Reports</h5>
                    <h3 class="mt-3 mb-3">{{$reports}}</h3>
                    <a href="{{route('admin.reports')}}" class="btn btn-light btn-sm text white">View Details</a>
          ...
          <div class="col-md-3 ">
            <div class="card bg-info widget-flat">
                <div class="card-body">
                    <div class="float-right">
                        <i class="mdi mdi-apps icon-lg"></i>
                    </div>
